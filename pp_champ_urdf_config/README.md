...
#### 1.2.1. Run the Gazebo environment:
    ...
    roslaunch pp_champ_urdf_config gazebo.launch 

#### 1.2.2. Run gmapping package and move_base:

    roslaunch pp_champ_urdf_config slam.launch rviz:=true
...
- Save the map by running:
      ...
      roscd pp_champ_urdf_config/maps
...
#### 1.3.2. Run amcl and move_base:
    ...
    roslaunch pp_champ_urdf_config navigate.launch rviz:=true
...
Spawning a robot:
    ...
    roslaunch pp_champ_urdf_config spawn_robot.launch robot_name:=<unique_robot_name> world_init_x:=<x_position> world_init_y:=<y_position>
